...
file = 'c:\\temp\\sso\\applications.txt'  #Lijst met applicaties
app_path = 'c:\\temp\\sso\\' #path waar applicaties en config bestanden staan
...
def New_Application():
    ...
    new_file.write(input("Enter URL: http://www.")+ "\n")    #URL wordt in bestandje weggeschreven 
    ...
    webbrowser.open("https://www." + new_app_url)    #opent ingevoerde url, "https://www." heb ik ervoor gezet omdat windows IE opent zonder.
...
class SSO_App:
    ...
    def Run(self, app):
        ...
        with open(app_path + app + ".txt") as credentials:  # open txt file with credentials + settings
            ...
            # open webbrowser etc..
            webbrowser.open("https://www." + app_url)
            time.sleep(1)
